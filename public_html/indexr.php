...
<TABLE cellSpacing=0 cellPadding=0 width=496 height=196 border=0>
  <TR>
  	<?php $user =& XMEC::getUser();
	        ...
	        <TD align=left><P class=body><b><a href="editprofile.php" class=flink>Your Profile</A> was last modified on <?php echo $user->get('last_update')?></P>
	        </b></TD>
	        </TR>
	        <TR>
	        <TD><P class=body><b>Please <a href="preferences.php" class=flink>change your password</A> to one of your choice.</P>
	        </b></TD>
	        </TR>
	        <TR>
	        <TD><P class=body><b>Please update <a href="preferences.php" class=flink>profile security</A> to one of your choice.</P>
	        </b></TD>
	        </TR>
	        <TR>
	        <TD><P class=body><b>Please update your Email ID(s) in the <a href="preferences.php" class=flink>XMEC Groups and Mailing Lists</A></P>
	        </b></TD>
	      <? else: ?>
    <TD width=25 height=146><img src="images/space.gif"></TD>
  	<TD width=446 valign=top><BR>
  	<P class=body>XMEC is the abbreviation for exMECians, the Alumni Association of Model Engineering College, Thrikkakara, Kochi. XMEC is an autonomous body representing thousand three hundred and more engineers who have earned their degrees in
...
<!--members login ends-->
  ...
  <TR>
			...
			<TR>
  				<TD height=29><A href="/statistics.php"class=flink><img src="images/dot.gif" border=0>Subscribe to XMEC</A></TD>
  			<? endif ?>
  </TR>
  <TR>
  	<TD align=center height=3 background="images/hdot.gif"><img src="images/space.gif"></TD>
