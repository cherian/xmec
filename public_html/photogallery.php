...
#				echo "$imgdir/$entry\n";
	...
	$gallery_prev  = "<A class=flink HREF=\"$thisfile?action=gallery&pagenum=$prev&number=$number&lang=$lang\">" .
											"<img src=images/back.gif border=0></A>";
	$gallery_next  = "<A class=flink HREF=\"$thisfile?action=gallery&pagenum=$next&number=$number&lang=$lang\">" .
