...
<P>select user_id, concat(first_name, ' ', middle_name, ' ', last_name) as name, date, description from xmec_logs, xmec_user where xmec_user.id = user_id and type = 'LOGIN' and date > '2003-11-01 00:00:00' order by date, name;</P>
