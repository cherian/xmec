...
<?php
  if(isset($IsError) && $action){
    echo "<p><b class=fbody>$IsError</b>";
  }
?>
<?php
...
<?php echo $PostVars; ?>
<table class="PhorumListTable" cellspacing="0" cellpadding="0" border="0">
<tr>
...
<tr>
  <td <?php echo bgcolor($ForumNavColor); ?>>
    ...
    <tr>
        ...
        <td height="23" <?php echo bgcolor($ForumTableBodyColor1); ?>><font color="<?php echo $ForumTableBodyFontColor1; ?>"><?php echo $p_author; ?></font><input class=lbox type="hidden" name="author" value="<?php echo $p_author; ?>"></td>
    </tr>
    <tr>
        ...
        <td height="23" <?php echo bgcolor($ForumTableBodyColor1); ?>><font color="<?php echo $ForumTableBodyFontColor1; ?>">
<?php if (isset($email1) && $email1 != "") { ?>
<select  class=cbox name=email>
<option value="<?=$email?>"><?=$email?></option>
<option value="<?=$email1?>"><?=$email1?></option>
</select></font>
<?php } else { ?>
<?php echo $p_email; ?></font><input type="hidden" name="email" value="<?php echo $p_email; ?>">
<?php } ?>
</td>
    </tr>
    <?php } else { ?>
    <tr>
        <td height="23" <?php echo bgcolor($ForumTableBodyColor1); ?> nowrap><font color="<?php echo $ForumTableBodyFontColor1; ?>">&nbsp;<?php echo $lFormName;?>:</font></td>
        <td height="23" <?php echo bgcolor($ForumTableBodyColor1); ?>><input class=lbox type="Text" name="author" size="30" maxlength="30" value="<?php echo $p_author; ?>"></td>
    </tr>
    <tr>
        <td height="23" <?php echo bgcolor($ForumTableBodyColor1); ?> nowrap><font color="<?php echo $ForumTableBodyFontColor1; ?>">&nbsp;<?php echo $lFormEmail;?>:</font></td>
        <td height="23" <?php echo bgcolor($ForumTableBodyColor1); ?>><input class=lbox type="Text" name="email" size="30" maxlength="200" value="<?php echo $p_email; ?>"></td>
    </tr>
    <?php } ?>
    <tr>
        ...
        <td height="23" <?php echo bgcolor($ForumTableBodyColor1); ?>><input class=lbox type="Text" name="subject" size="30" maxlength="80" value="<?php echo $p_subject; ?>"></td>
    </tr>
    <?php
      if ($AllowAttachments && $ForumAllowUploads == 'Y' && $ForumMaxUploads<4) {
    ...
    ?>
    <tr>
        <td <?php echo bgcolor($ForumTableBodyColor1); ?> colspan=2 width="100%" nowrap align="left"><table cellpadding="5" cellspacing="0" border="0"><tr><td align="CENTER" valign="TOP"><font face="courier"><textarea class=tbox class="PhorumBodyArea" name="body" cols="45" rows="20" wrap="VIRTUAL"><?php echo $p_body; ?></textarea></font></td></tr></table></td>
    </tr>
