...
$poll_baseURL = "/poll/polls"; // base path of script
						// NO slash at the end!

$poll_mySQL_host = "mysql.addr.com";		// hostname of MySQL database
$poll_mySQL_user = "xmec";			// MySQL username
$poll_mySQL_pwd = "raskals";			// MySQL password

$poll_dbName = "xmec";			// database to store the tables in
...
$poll_logging = 1;				// do you want phpPolls to log every vote?
...
$poll_warnCheaters = 1;				// 1 - if a cookie is present and a user tries
