...
$sql = "select concat(first_name, ' ', middle_name, ' ', last_name) as name, branch,msn,concat('\downloads\resume\',first_name,'_',last_name,'.rtf') as link from xmec_user where ".$condition;
