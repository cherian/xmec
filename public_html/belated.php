...
where ';
	...
	$query2 = '
		(
			(RIGHT(date_of_birth,5) >= RIGHT(DATE_SUB(CURRENT_DATE,INTERVAL 7 DAY),5)) and
			(RIGHT(date_of_birth,5) < RIGHT(DATE_ADD(CURRENT_DATE,INTERVAL 0 DAY),5))
		)
...
';
?>
<center><br>XMECians celebrating <A class=flink href="birthday.php">Birthdays this week</A><br></center>
<?php
include 'footer.php';
?>
