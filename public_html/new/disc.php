...
<b>GENERAL </b>
<P class=body>You acknowledge that no joint venture, partnership, employment, or agency relationship exists between you and XMEC, as a result of your use of our site. You agree not to hold yourself out as a representative, agent or employee for XMEC, and that xmec.net will not be liable by reason of any representation, act or omission to act by you. </P>
...
<B>GNU Related</B>
<P class=body> Some of the code used in this site may be downloaded from php source code libraries. They have been modified to be integrated into the site. These include the code for</P>
<UL><LI>Discussion Boards - From www.phorum.org</LI>
		<LI>Calendar - LLC Proverbs, www.proverbs.biz</LI></UL></P>
  	</TD>
  </TR>
</TABLE>
