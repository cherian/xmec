...
//    if($ForumModeration!="a"){
      ...
      $ebody = '';
      if ($id) {
        $ebody.="On your request,this message was sent from the XMEC Discussion namely: $ForumName.\n";
        $ebody.="<$forum_url/$read_page.$ext?f=$num&i=$id&t=$thread> \n";
        $ebody.="----------------------------------------------------------------\n\n";
      }
      $ebody.=textwrap($plain_body)."\n\n";
      $ebody.="----------------------------------------------------------------\n";
      $ebody.="Sent from the XMEC site <www.xmec.net>. Login in to reply to this message";
