...
<TABLE cellSpacing=0 cellPadding=4 border=0>
  <TR>
  	<TD valign=top width=90% class=body><BR><BR>Many of the facilities of this site are exclusive to the alumni of MEC, and <strong>hence will not be available to the general internet user</strong>. Any inconvenience caused is regretted. All XMECians who have earned their degrees from Model Engineering College are <strong>members by default.<BR><BR>In case you have not received your Login details, please enter your details so that the XMEC Moderator can process your request for Login. </strong>
