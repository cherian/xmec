...
<table width="<?php echo $table_width; ?>" border="0" cellspacing="0" cellpadding="3">
  <tr>
    <td class="PhorumListTable" <?php echo bgcolor($nav_color); ?> valign="TOP" nowrap><?php echo $TopNav; ?></td>
  </tr>
</table>
<?php
  }
...
?>
<TR class="PhorumListTable">
  <TD nowrap bgcolor="<?php echo $table_body_color_1; ?>"><FONT color="<?php echo $table_body_font_color_1; ?>" >&nbsp;<a class="PhorumForumTitle" href="<?php echo $url; ?>"><?php echo $name; ?></a></font></TD>
