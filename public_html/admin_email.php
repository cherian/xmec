...
<form name="XMECMail" method="post"action="amail.php">
...
<TD width=300><INPUT  NAME="sendername"  value="<?php echo $user->first_name ?> <?php echo $user->last_name ?>" class=lbox>
</TD></TR>
<TR>
<TD width=125 class=name>From</TD>
<TD width=300><INPUT  NAME="senderemail"  value="<?php echo $user->personal_email ?>" class=lbox>
</TD></TR>
<TR>
...
<TD width=300><INPUT NAME="ccrecipient" class=lbox>
</TD></TR>
<TR>
<TD width=125 class=name>Bcc</TD>
<TD width=300><INPUT NAME="bccrecipient" class=lbox>
</TD></TR>
<TR>
<TR>
